    ...
    floors: [
      {
        ...
        doors: [
          { id: 'door-1', x: 500, y: 100, width: 80, capacity: 3, orientation: 'horizontal', throughput: 1.5, direction: 'outward', autoOpen: false, currentQueue: 0 },
    ...
    floors: [
      {
        ...
        walls: [
          ...
          { x1: 550, y1: 50, x2: 950, y2: 50 },
          { x1: 950, y1: 50, x2: 950, y2: 650 },
          { x1: 950, y1: 650, x2: 550, y2: 650 },
          { x1: 450, y1: 650, x2: 50, y2: 650 },
        ...
        doors: [
          { id: 'door-5', x: 500, y: 50, width: 80, capacity: 3, orientation: 'horizontal', throughput: 1.5, direction: 'outward', autoOpen: false, currentQueue: 0 },
          { id: 'door-6', x: 500, y: 650, width: 80, capacity: 3, orientation: 'horizontal', throughput: 1.5, direction: 'outward', autoOpen: false, currentQueue: 0 },
          { id: 'door-7', x: 500, y: 200, width: 80, capacity: 3, orientation: 'horizontal', throughput: 1.5, direction: 'both', autoOpen: false, currentQueue: 0 },
          { id: 'door-8', x: 500, y: 500, width: 80, capacity: 3, orientation: 'horizontal', throughput: 1.5, direction: 'both', autoOpen: false, currentQueue: 0 },
        ],
        exits: [
    ...
    floors: [
      {
        ...
        walls: [
          ...
          { x1: 550, y1: 100, x2: 900, y2: 100 },
          { x1: 900, y1: 100, x2: 900, y2: 600 },
          { x1: 900, y1: 600, x2: 550, y2: 600 },
          { x1: 450, y1: 600, x2: 100, y2: 600 },
          { x1: 100, y1: 600, x2: 100, y2: 100 },
        ...
        doors: [
          { id: 'door-9', x: 500, y: 100, width: 80, capacity: 3, orientation: 'horizontal', throughput: 1.5, direction: 'outward', autoOpen: false, currentQueue: 0 },
          { id: 'door-10', x: 500, y: 600, width: 80, capacity: 3, orientation: 'horizontal', throughput: 1.5, direction: 'outward', autoOpen: false, currentQueue: 0 },
          ...
          { id: 'door-13', x: 200, y: 400, width: 60, capacity: 2, orientation: 'horizontal', throughput: 1.2, direction: 'both', autoOpen: false, currentQueue: 0 },
          { id: 'door-14', x: 700, y: 400, width: 60, capacity: 2, orientation: 'horizontal', throughput: 1.2, direction: 'both', autoOpen: false, currentQueue: 0 },
        ],
        exits: [
      ...
      },
      {
        ...
        doors: [
          { id: 'door-15', x: 200, y: 300, width: 60, capacity: 2, orientation: 'horizontal', throughput: 1.2, direction: 'both', autoOpen: false, currentQueue: 0 },
          { id: 'door-16', x: 700, y: 300, width: 60, capacity: 2, orientation: 'horizontal', throughput: 1.2, direction: 'both', autoOpen: false, currentQueue: 0 },
        ],
        exits: [
      ...
      },
      {
        ...
        doors: [
          { id: 'door-17', x: 500, y: 300, width: 60, capacity: 2, orientation: 'vertical', throughput: 1.2, direction: 'both', autoOpen: false, currentQueue: 0 },
        ],
        exits: [
    ...
    floors: [
      {
        id: 1,
        walls: [
          { x1: 200, y1: 200, x2: 450, y2: 200 },
          { x1: 550, y1: 200, x2: 800, y2: 200 },
        ...
        doors: [
          { id: 'door-18', x: 500, y: 200, width: 80, capacity: 3, orientation: 'horizontal', throughput: 1.5, direction: 'outward', autoOpen: false, currentQueue: 0 },
        ],
        exits: [
    ...
    floors: [
      {
        ...
        doors: [
          { id: 'door-19', x: 500, y: 150, width: 80, capacity: 3, orientation: 'horizontal', throughput: 1.5, direction: 'outward', autoOpen: false, currentQueue: 0 },
          { id: 'door-20', x: 400, y: 250, width: 60, capacity: 2, orientation: 'vertical', throughput: 1.2, direction: 'both', autoOpen: false, currentQueue: 0 },
          { id: 'door-21', x: 600, y: 250, width: 60, capacity: 2, orientation: 'vertical', throughput: 1.2, direction: 'both', autoOpen: false, currentQueue: 0 },
        ],
        exits: [
